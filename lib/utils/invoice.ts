...
<body style="padding:40px;max-width:800px;margin:0 auto">
  ...
  <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:40px">
    ...
    <div style="text-align:right">
      ...
      <p style="font-size:16px;font-weight:600;color:${accent};margin-top:4px">${invoice.invoice_number}</p>
  ...
  <div style="display:flex;justify-content:flex-end;margin-bottom:32px">
    <div style="min-width:280px">
      ...
      <div style="display:flex;justify-content:space-between;padding:10px 0;border-top:2px solid #0f172a;margin-top:4px">
        ...
        <span style="font-size:18px;font-weight:800;color:${accent}">${fmt(invoice.total_amount)}</span>
      </div>
      ${invoice.amount_paid > 0 && invoice.amount_paid < invoice.total_amount ? `
      <div style="display:flex;justify-content:space-between;padding:8px;background:#fef2f2;border-radius:6px;margin-top:8px">
  ...
  <div style="border-top:1px solid #e2e8f0;padding-top:16px;text-align:center">
    ...
    <p style="color:#94a3b8;font-size:11px">Generated by VANTAGE</p>
  </div>
</body>
</html>`;
}
