...
<body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#f8fafc;padding:40px 20px;margin:0;">
  <div style="max-width:520px;margin:0 auto;background:white;border-radius:16px;padding:40px;box-shadow:0 4px 24px rgba(0,0,0,0.07);">
    <div style="width:44px;height:44px;background:#1a9c38;border-radius:10px;display:inline-flex;align-items:center;justify-content:center;margin-bottom:24px;">
    ...
    <p style="color:#64748b;font-size:15px;line-height:1.7;margin:0 0 28px;">
      ...
      <strong style="color:#1a9c38;">${roleLabel}</strong>.
    </p>
    <a href="${inviteUrl}" style="display:inline-block;background:#1a9c38;color:white;text-decoration:none;font-weight:600;font-size:14px;padding:13px 30px;border-radius:10px;margin-bottom:28px;">
      Accept Invitation →
    </a>
